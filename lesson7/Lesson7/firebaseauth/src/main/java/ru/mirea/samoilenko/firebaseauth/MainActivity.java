package ru.mirea.samoilenko.firebaseauth;
...
import ru.mirea.samoilenko.firebaseauth.databinding.ActivityMainBinding;
    ...
    private void createAccount(String email, String password) {
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    ...
                    Log.d(TAG, "createAccount complete. Success = " + task.isSuccessful());
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Log.d(TAG, "User uid: " + (user != null ? user.getUid() : "null"));
    ...
    private void signIn(String email, String password) {
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    ...
                    Log.d(TAG, "signIn complete. Success = " + task.isSuccessful());
        ...
        user.sendEmailVerification()
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Log.e(TAG, "sendEmailVerification failure", exception);
